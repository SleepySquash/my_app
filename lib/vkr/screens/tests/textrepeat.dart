...
class TextTestScreen extends StatefulWidget {
  @override
  _TextTestScreenState createState() => _TextTestScreenState();
}
    ...
    WidgetsBinding.instance!.addPostFrameCallback((_) async {
      ...
      dialog = AwesomeDialog(
        ...
        body: Padding(
          ...
          child: EventStarter(
            caption: 'Набрать текст',
            description: 'Повторите отображаемый на экране текст',
            icon: Icons.article,
            onCancel: () {
              dialog?.dissmiss();
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: 'Повторите текст сверху',
                ),
              ),
            ),
            Padding(
              ...
              child: Column(
                children: [
                  AnimatedButton(
                    text: _controller.text.isEmpty ? "Отмена" : "Готово",
                      ...
                      if (_controller.text.isEmpty)
                        ...
                        sendRequestPopup(context,
                            map: {
                              'phone': Person.phone ?? '',
                              'accuracy': text
                                  .similarityTo(_controller.text)
                                  .toString(),
                              'keys': keys.toString(),
                              'backspaces': backspaces.length > 0
                                  ? backspaces.toString()
                                  : '',
